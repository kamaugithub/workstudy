...
class _SupervisorDashboardState extends State<SupervisorDashboard>
  ...
  Future<void> _exportPDF(
    ...
    try {
      ...
      // Get student email (use first activity's student email or supervisor email as fallback)
      final studentEmail = activities.isNotEmpty
          ? activities.first['studentEmail'] ?? supervisorName
          : supervisorName;
